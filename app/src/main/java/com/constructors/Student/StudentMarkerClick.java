...
public class StudentMarkerClick extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_marker_click);
        ...
        String getMarkerTitle = MapsShowAllTutors.passingMarkerTitle;
...
//                String phone = "+34666777888";
        ...
        databaseReferenceTutors.child(getMarkerTitle).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        databaseReferenceTutors.child(getMarkerTitle).child("info").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        databaseReferenceTutors.child(getMarkerTitle).child("Classes").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                final ArrayAdapter<String> adapter1 = new ArrayAdapter<>(StudentMarkerClick.this, R.layout.tutor_profile_list_view, propertyAddressList);

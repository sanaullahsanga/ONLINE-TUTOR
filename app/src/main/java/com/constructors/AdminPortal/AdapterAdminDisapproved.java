...
public class AdapterAdminDisapproved extends RecyclerView.Adapter<AdapterAdminDisapproved.MyViewHolder> {
    ...
    public AdapterAdminDisapproved(Context c , ArrayList<String> p, ArrayList<String> q, ArrayList<String> a , ArrayList<String> qual , ArrayList<String> e, ArrayList<String> u)
    {
        context = c;
        tutorInfo = p;
        nameTutor = q;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.showTutorProf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context , AdminWaitingTutorProfile.class);
